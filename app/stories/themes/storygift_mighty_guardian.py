...
STORYGIFT_MIGHTY_GUARDIAN_THEME = StoryTemplate(
    ...
    pages=[
        ...
        PageTemplate(
            ...
            scene_type="action",
            realistic_prompt="""Epic power awakening scene. The child named {name} in full superhero costume with metallic blue and red suit, gold accents, and flowing cape, standing on a city rooftop at golden hour. Child's right fist raised upward glowing with brilliant blue energy, a massive golden energy shield expanding outward from their body in a shockwave ring. Cape billowing dramatically behind in the wind. Child's face shows exhilarated determination and wonder, mouth slightly open in awe at their own power, looking toward camera. Blue and gold energy crackling around the child's body like lightning. City skyline behind with sunset casting dramatic orange and purple light. Energy particles and sparks swirling upward. Single child, single face, front-facing portrait composition with the child filling the center of the frame. Cinematic superhero movie quality, dramatic backlighting, lens flare from the energy burst. Child's face clearly visible and detailed, well-lit by the energy glow.""",
        ...
        PageTemplate(
            ...
            scene_type="heroic",
            realistic_prompt="""Heroic response moment. Low angle shot looking up at enormous oak tree with a tiny frightened kitten visible on the highest branch, meowing for help, sunlight filtering through leaves. In foreground, the child named {name} in superhero costume looking up with determination and compassion, one fist raised confidently ready to leap into action, other hand on hip in confident pose — face fully unobstructed, both eyes and full face clearly visible with no hand or object obscuring any facial features. Below, a worried child who owns the kitten is pointing up with tears, positioned small and out of focus. The composition emphasizes the height and challenge. Guardian is about to leap into action. Golden afternoon light, detailed tree bark and leaves, emotional storytelling through body language. Child's determined compassionate face is the clear focal point.""",
        ...
        PageTemplate(
            ...
            scene_type="climax",
            realistic_prompt="""Epic storm battle, medium close-up composition. The child named {name} in superhero costume flying through stormy sky, upper body and face filling one-third of the frame prominently. Both arms extended forward with golden energy beams shooting from hands toward dark purple storm clouds. Child's cape whips dramatically behind, rain droplets frozen mid-air around them. Lightning from within the storm clouds illuminates the child's face from behind, creating dramatic rim lighting. Child's face shows intense concentration and fierce determination, jaw set, eyes focused forward toward camera, glowing with protective golden energy. Wind-blown hair, rain streaking past. Dark dramatic storm clouds surround the child but do not obscure the face. Town with twinkling lights visible far below in soft focus. Cinematic superhero action shot with child as the clear, prominent hero. Child's determined face is the absolute focal point, well-lit by their own golden energy glow contrasting against the dark storm.""",
