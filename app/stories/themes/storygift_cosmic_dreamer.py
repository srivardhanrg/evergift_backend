...
# === PAGE 1 - THE SPACE MUSEUM ===
    PageTemplate(
        ...
        PageTemplate(
            ...
            realistic_prompt="""Magical transformation scene on Earth at night. The child named {name} standing proudly in a moonlit grassy field next to the parked silver-and-gold spaceship, wearing a beautiful white astronaut suit with silver and gold star accents. The helmet is held under one arm (not on head), showing the child's face clearly. Swirling golden stardust sparkles wrap around the child's body as the suit finishes magically forming. Child has a confident, beaming expression with a natural excited smile, looking directly at camera. The suit glows softly with magical light. The background is a vast dramatic night sky stretching across the majority of the frame — deep navy blue filled with thousands of brilliant twinkling stars, the Milky Way faintly visible, a bright crescent moon casting silver light across the field. Dewy grass underfoot reflects the moonlight. The spaceship's warm golden interior light spills from its open doorway nearby, adding warm rim light on the child. Still firmly on the ground, not in space yet — the stars above are what the child is about to explore. Child's face is the absolute focal point, well-lit by moonlight and the ship's warm glow, detailed, front-facing portrait style. Premium cinematic quality. Child's natural skin tone preserved exactly as in reference photo regardless of scene lighting. A small excited comic-style speech bubble near the child containing EXACTLY the text "I'm really going to space!", subtle and not covering the face.""",
        ...
        PageTemplate(
            ...
            scene_type="wonder",
            realistic_prompt="""Magical zero gravity scene inside a spacecraft. The child named {name} in astronaut suit floating gently in the cabin, arms spread out in joy, small glowing stars floating around. Child's face shows pure delight with a bright natural smile, looking toward camera. Soft blue and purple ambient light from windows showing space outside. The child is floating but face is clearly visible, well-lit, front-facing. Dreamy, weightless atmosphere. Small sparkles and stars drift past gently. Child's natural skin tone preserved exactly as in reference photo regardless of scene lighting. Whimsical, magical quality. A small joyful comic-style speech bubble near the child containing EXACTLY the text "This is the best feeling ever!", subtle and not covering the face.""",
