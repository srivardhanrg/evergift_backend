...
STORYGIFT_COSMIC_DREAMER_THEME = StoryTemplate(
    ...
    pages=[
        ...
        PageTemplate(
            page_number=2,
            scene_description="A real spaceship with open door awaits the child",
            scene_type="wonder",
            realistic_prompt="""Magical outdoor night scene. The child named {name} in casual clothes standing in a grassy field at night, looking at a magnificent real silver and gold spaceship that has landed nearby. The spaceship door is open, glowing with warm golden light from inside, inviting the child in. The child stands in the foreground facing the spaceship, head turned slightly toward camera showing an expression of amazed joy and excitement, gentle smile. Starry night sky above. The spaceship is clearly separate from the child, positioned to the side with its glowing door open. Soft golden light from the spaceship illuminates the child's face. Simple clean composition. Child's natural skin tone preserved exactly as in reference photo regardless of scene lighting. Magical, inviting atmosphere.""",
        ...
        PageTemplate(
            ...
            scene_type="bonding",
            realistic_prompt="""Enchanting stardust collection scene. The child named {name} in astronaut suit, holding a glowing glass jar filled with swirling golden stardust. Child looking at the jar with gentle wonder, soft peaceful smile, face beautifully lit by the warm golden glow of the stardust. Space and stars visible in the soft-focus background. The jar casts magical light patterns on the child's face. Child positioned in center frame, face clearly visible, three-quarter view toward camera. Intimate, magical moment. Child's natural skin tone preserved exactly as in reference photo regardless of scene lighting. Cinematic warm lighting.""",
        ...
        PageTemplate(
            ...
            scene_type="peaceful",
            realistic_prompt="""Emotional homecoming scene. The child named {name} in astronaut suit, standing at a large spacecraft window, both hands pressed gently against the glass. Child looking at the beautiful blue Earth visible through the window, face showing a warm, peaceful smile of contentment and happiness. Earth's blue glow softly illuminates the child's happy face. Child in three-quarter profile, face clearly visible and well-lit. Soft reflections of Earth visible in the window glass. Tender, heartwarming moment. Child's natural skin tone preserved exactly as in reference photo regardless of scene lighting. Cinematic, emotional quality.""",
