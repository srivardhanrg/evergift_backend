...
STORYGIFT_COSMIC_DREAMER_THEME = StoryTemplate(
    ...
    pages=[
        ...
        PageTemplate(
            ...
            realistic_prompt="""Magical backyard scene at twilight. The child named {name} in pajamas stands in awe before a magnificent silver and blue rocket ship with the name glowing in neon letters on the side. The rocket has a translucent glass dome showing a cozy interior with stars projected inside. Fireflies dance around, the child's house is warmly lit in background, purple and pink sunset sky. Child's face shows pure wonder and excitement. Dreamy, warm lighting with magical glow effects. Detailed grass and garden, soft focus background. **A small playful comic-style speech bubble near the child saying "WOW!", subtle and not covering the face.**""",
        ...
        PageTemplate(
            ...
            scene_type="action",
            realistic_prompt="""Thrilling cockpit launch scene. Interior view of rocket cockpit with the child named {name} sitting in pilot seat facing toward camera, wearing shiny white astronaut suit with colorful mission patches. Child's excited face lit by the glow of colorful control panel lights, expression of pure joy and determination, both eyes sparkling with excitement. Hands gripping the controls, big triumphant smile. Through the curved cockpit window behind child: spectacular view of clouds rushing past, stars appearing, magical rainbow sparkles and stardust trails. Child's face is the focal point, clearly visible and detailed, looking vibrant with the thrill of liftoff. Cinematic interior lighting with dramatic shadows.""",
        ...
        PageTemplate(
            ...
            scene_type="triumph",
            realistic_prompt="""Iconic moon landing moment. The child named {name} in detailed white and gold astronaut suit with clear helmet showing joyful face, mid-bounce on the lunar surface with moon dust particles suspended in air around their boots. One arm raised triumphantly, the other holding a flag with their name. Footprints trail behind them in silver moon dust. Enormous Earth rises on the horizon, glowing blue and green and white against the black star-filled space. Dramatic lighting with sun creating long shadows and golden rim light on the suit. Craters and lunar rocks frame the composition. Frame-worthy, epic cinematic scene. **A small triumphant comic-style speech bubble near the child saying "I did it!", subtle and not covering the face.**""",
