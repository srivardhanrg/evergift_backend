...
STORYGIFT_SAFARI_ADVENTURE_THEME = StoryTemplate(
    ...
    pages=[
        ...
        PageTemplate(
            ...
            scene_type="adventure",
            realistic_prompt="""Heroic portrait scene in African red rock canyon. Child {name} in khaki safari outfit sitting tall and upright on KITO's back — a powerful wild African horse with golden-brown coat and flowing dark mane, positioned slightly sideways to show his full magnificent form. Child faces the camera confidently at a natural 3/4 angle, one hand resting lightly on Kito's mane, chin slightly raised with a proud adventurous smile — the pose of a true guardian, exhilarated from the ride. Child's face is the clear PRIMARY FOCAL POINT, well-lit by warm golden afternoon light streaming through the canyon. Dramatic red rock canyon walls rise on either side framing the pair like a natural arch. Kito stands steady and powerful, head held high. A swirl of golden dust still settling around their feet from the gallop, particles catching the canyon light. Heartstone Compass glowing warmly on child's chest. Child occupies upper 60% of frame, face large and clearly detailed. Classic hero-on-horseback composition. BBC Earth documentary quality, cinematic lighting, soft focus canyon background, sharp focus on child's face.""",
        ...
        PageTemplate(
            ...
            scene_type="action",
            realistic_prompt="""Breathtaking wonder scene in golden African savanna. Child {name} in khaki safari outfit kneeling in lush golden grass beside NIA — a strikingly beautiful zebra with bold, crisp black-and-white stripes glowing in afternoon sunlight. Child's hand gently extended, one finger delicately tracing along Nia's magnificent stripes with pure fascination and awe. Child's face turned naturally toward camera at a relaxed 3/4 angle — expression of absolute wonder and delight, eyes wide, gentle smile, completely enchanted by the magic of the moment. Child's face is the clear PRIMARY FOCAL POINT, beautifully lit by warm golden afternoon light. Nia standing steady, neck curved gently toward the child in a tender, trusting gesture. Heartstone Compass glowing warmly on child's chest, reflecting in Nia's dark eye. The stripes seem to shimmer with a subtle magical golden sheen in the light. Vast open savanna behind them — golden grass swaying, distant acacia silhouettes, dramatic warm sky. Child and zebra in intimate close-up foreground, child's face large and clearly detailed. Rich wow-factor composition, magazine-cover quality. National Geographic wildlife intimacy quality, soft focus savanna background, sharp focus on child's face.""",
            ...
            face_expression="pure fascination and wonder, eyes wide with delight, gentle enchanted smile"
        ),
        ...
        PageTemplate(
            ...
            scene_type="wonder",
            realistic_prompt="""Magical underwater scene at golden hour. Child {name} in safari outfit riding on MAKENA's back - massive gentle hippopotamus swimming gracefully underwater. Child holding hippo's back, face turned naturally toward camera at a relaxed 3/4 angle — expression of absolute wonder and delight, eyes wide open, mouth slightly open in amazement. Surrounded by stream of magical golden bubbles from Heartstone Compass. Warm golden sunset light rays piercing down through crystal-clear water surface above, creating cathedral-like light beams that illuminate the child's face brightly and clearly. Natural skin tones on the child's face, face is the bright PRIMARY FOCAL POINT against the darker water background. Fish swimming around them. Child's face large and clearly detailed, well-lit by the warm golden light from above. Only child riding hippo, mystical serene two-character composition. Underwater plants swaying gently. Magical underwater cinematography like BBC Blue Planet, soft focus background.""",
        ...
        PageTemplate(
            ...
            scene_type="bonding",
            realistic_prompt="""Magical ceremony at the Great Tree. CHILD {name} IS THE CLEAR FOCAL POINT - wearing khaki safari explorer outfit, standing tall at the base of the Great Tree (massive baobab with golden glowing leaves). The GREAT OWL perched on a low branch directly at the child's shoulder height, beak delicately placing a shimmering golden feather into the child's hair — the exact moment of the ceremony. Child's face turned naturally toward camera at a relaxed 3/4 angle, expression of overwhelming joy and pride, eyes glistening with emotion, absorbing the magnitude of being named Guardian. Child's face is the clear PRIMARY FOCAL POINT, beautifully lit by the warm golden magical glow radiating from the feather at hair level, casting soft golden light naturally across their features from above. Owl's wise eyes gentle and ceremonial, wings slightly open in a blessing gesture. Heartstone Compass glowing softly on child's chest — glow contained to chest and vest area, not casting upward onto face. Background animals (elephant, zebra, cheetah) shown only as DISTANT BLURRED silhouettes in a circle far behind. Purple-pink twilight sky with first stars appearing. Child takes up 60% of frame height, face large and clearly detailed. BBC Earth documentary quality, face dramatically lit, very soft blur on everything except child and owl.""",
            ...
            face_expression="overwhelming joy and pride, eyes glistening with emotion, soft awed smile, deeply moved"
        ),
