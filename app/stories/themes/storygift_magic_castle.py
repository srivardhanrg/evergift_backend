...
STORYGIFT_MAGIC_CASTLE_THEME = StoryTemplate(
    ...
    pages=[
        ...
        PageTemplate(
            ...
            scene_type="chaos",
            realistic_prompt="""Magical chaos scene in the library. The child named {name} standing near the table, facing DIRECTLY toward the camera with an expression of surprised delight, laughing joyfully with arms partially raised. Child's face is the clear PRIMARY FOCAL POINT — large, centered, and fully unobstructed, well-lit by warm candlelight from the side. In the BACKGROUND BEHIND the child: hundreds of books flying like a flock of birds across the high-ceilinged room. Midnight (a sleek black cat with glowing yellow eyes and silver collar) leaping mid-air to catch a book in the far background. All flying books stay BEHIND and to the SIDES of the child — nothing flies in front of or toward the child's face. The library chaos creates an exciting backdrop while the child's amused laughing face remains clearly visible and detailed in the foreground. The child is wearing wizard robes.""",
