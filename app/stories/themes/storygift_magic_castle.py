...
STORYGIFT_MAGIC_CASTLE_THEME = StoryTemplate(
    ...
    pages=[
        ...
        PageTemplate(
            ...
            scene_type="bonding",
            realistic_prompt="""Heartwarming bonding scene in stone courtyard. The child named {name} kneeling next to the open crate, face lit with gentle smile, offering a treat to Sparky - a tiny adorable baby dragon, red with orange wings, breathing a tiny puff of harmless smoke. Child's kind expression showing compassion and wonder as they befriend the creature. Castle walls in background. Warm afternoon light. Child's gentle smiling face clearly visible and detailed, showing connection with the baby dragon. The child is wearing wizard robes.""",
        ...
        PageTemplate(
            ...
            scene_type="mischief",
            realistic_prompt="""Intimate library exploration scene. The child named {name} sitting at an ancient wooden table in the magnificent library, carefully opening a large dusty leather-bound book with golden magical symbols on its cover. Child's face illuminated by soft golden light emanating from the book's pages, expression showing wonder and mischievous curiosity. Midnight (a sleek black cat with glowing yellow eyes and silver collar) sitting beside them on the table watching intently. Towering magical bookshelves in background, sunbeams filtering through high windows catching dust motes like sparkles. Child's curious fascinated face clearly visible and detailed, lit by the magical book's glow. The child is wearing wizard robes.""",
        ...
        PageTemplate(
            ...
            scene_type="peaceful",
            realistic_prompt="""Perfect storybook ending. The child named {name} in elegant formal wizard robes sitting on the edge of the Astronomy Tower balcony, Midnight the black cat curled up in their lap. Child's face turned toward camera with warm peaceful smile, silver moonlight beautifully illuminating their happy expression. Giant twin moons glow warmly in the starry night sky. Village lights twinkle like stars far below. Child gently petting the purring cat, expression of belonging and joy. Magical atmosphere with subtle sparkles in the air. Portrait composition with child's content smiling face clearly visible and detailed. Warm, safe, hopeful feeling of finding home.""",
